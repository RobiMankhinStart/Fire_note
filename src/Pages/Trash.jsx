        ...
        <div className="trashDiv flex flex-col gap-8">
          <div className=" flex justify-center shadow-md rounded-lg p-2">
            <button
              ...
              className="inline-flex text-xl font-semibold font-mono items-center px-4 py-2 bg-red-600 transition ease-in-out delay-75 hover:bg-red-700 text-white  rounded-md hover:-translate-y-1 hover:scale-110"
            >
              <svg
                stroke="currentColor"
                viewBox="0 0 24 24"
